...
import io.application.gui.console.Emoji;
import io.exception.EasterEggFileException;
		...
		private void answerChocolateMenuFor(int option) {
			...
			case 2:
				try {
					...
					// On affiche le cadeau à la place de l'ASCII art
					System.out.println("🎁 Surprise gift instead of the easter egg!");
				}
				console.message(Emoji.CHOCOLATE_BAR+ " The best chocolate for easter !" + Emoji.CHOCOLATE_BAR);
				break;
			case 3:
