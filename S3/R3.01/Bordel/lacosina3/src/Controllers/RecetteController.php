...
class RecetteController
{
  ...
  function aApprouver()
  {
    // si il est pas admin, on le redirige
  ...
  {
    $recipes = $this->recetteModel->findBy(['isApproved' => 0, 'auteur' => $_SESSION['mail']]);
  ...
  function compterRecettesNonValidees()
  {
    return count($this->recetteModel->findBy(['isApproved' => 0]));
  }
}
