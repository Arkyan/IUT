...
class CommentaireController
{
  ...
  {
    $comments = $this->commentaireModel->findBy(['isApproved' => 0, 'pseudo' => $_SESSION['identifiant']]);
    require_once(__DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'Views' . DIRECTORY_SEPARATOR . 'commentaire' . DIRECTORY_SEPARATOR . 'enCoursValidation.php');
  }

  function compterCommentairesNonValides()
  {
    return count($this->commentaireModel->findBy(['isApproved' => 0]));
  }
}
