      ...
      <?php if (isset($_SESSION['identifiant'])) { ?>
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href='?c=recette&a=enCoursValidation'>Mes recettes en attente</a></li>
            <li><a class="dropdown-item" href='?c=recette&a=ajouter'>Ajouter une recette</a></li>
            <li><a class="dropdown-item" href='?c=commentaire&a=enCoursValidation'>Mes commentaires en attente</a></li>
            <?php if (isset($_SESSION['isAdmin']) && $_SESSION['isAdmin']) { ?>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li><a class="dropdown-item" href='?c=commentaire&a=liste'>Liste des commentaires</a></li>
              <li><a class="dropdown-item" href='?c=recette&a=aApprouver'>Recettes à approuver
                  <?php if ($nbRecettesAValider > 0) { ?>
                    <span class="badge bg-danger"><?php echo $nbRecettesAValider; ?></span>
                  <?php } ?>
                </a></li>
              <li><a class="dropdown-item" href='?c=commentaire&a=aApprouver'>Commentaires à approuver
                  <?php if ($nbCommentairesAValider > 0) { ?>
                    <span class="badge bg-danger"><?php echo $nbCommentairesAValider; ?></span>
                  <?php } ?>
                </a></li>
            <?php } ?>
          </ul>
